...
class World : public QLabel {
  ...
  public:
    ...
    QSize getWorldPixelSize() const {
        return { worldPixelWidth, worldPixelHeight};
    }

    bool isShowVisitedPath() const {
        return showVisitedPath;
    }
    int  getShowVisitedPathInterval() const {
        return showVisitedPathInterval;
    }
    ...
    const QColor& getObstacleColor() {
        setAllAlpha();
        return obstacleColor;
    }
    const QColor& getSrcColor() const {
        return srcColor;
    }
    const QColor& getDestColor() const {
        return destColor;
    }
    const QColor& getVisitedColor() {
        setAllAlpha();
        return visitedColor;
    }
    ...
    bool setBgFlag(bool real, const QString& name = "") {
        haveBackground = real;
        setAllAlpha();
        return bgImage.load(name);
    }
  ...
  public slots:
    ...
    ***/
    ...
    void setPathColor(const QColor& c) {
        pathColor = c;
        refreshAll();
    }
    ...
    void setObstacleColor(const QColor& c) {
        obstacleColor = c;
        refreshAll();
    }
    void setSrcColor(const QColor& c) {
        srcColor = c;
        refreshAll();
    }
    void setDestColor(const QColor& c) {
        destColor = c;
        refreshAll();
    }
    void setVisitedColor(const QColor& c) {
        visitedColor = c;
        refreshAll();
    }
    void resetColors();
    ...
    ***/
    ...
    /*   Diagonal Move
    ***/
    void setEnableDiagonalMove(bool enable) {
        enableDiagonalMove = enable;
    }

    /*   visited path
    ***/
    void visited(int x, int y);
    void setShowVisitedPath(bool show) {
        showVisitedPath = show;
    }
    void setShowVisitedPathInterval(int interval) {
        showVisitedPathInterval = interval;
    }
